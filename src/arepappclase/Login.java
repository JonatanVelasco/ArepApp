...
public class Login extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        JL_inicioSesion.setForeground(new java.awt.Color(0, 0, 0));
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addComponent(JL_inicioSesion, javax.swing.GroupLayout.DEFAULT_SIZE, 272, Short.MAX_VALUE)
        );
    ...
    private void JL_inicioSesionMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JL_inicioSesionMouseClicked
        try {
            ...
            int rol = 0;
            String sql = "SELECT codigo_rol FROM usuarios WHERE usuario = ? AND pass = ?";
            ...
            if (rs.next()) {
                rol = rs.getInt("codigo_rol");
            }

            // Cerrar la conexión a la base de datos
            conexion.estableceConexion().close();

            // Comprobar el rol del usuario y mostrar la página correspondiente
            if (rol == 500) {
                GestionProductos productos = new GestionProductos();
                Menu.escritorio.add(productos);
                productos.setVisible(true);
                this.dispose();

                JOptionPane.showMessageDialog(null, "Acceso Correcto");
                // Aquí se muestra la página de administrador
            } else if (rol == 503) {
                Cliente cliente = new Cliente();
                Menu.escritorio.add(cliente);
